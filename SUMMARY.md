...
* [Routing](the-basics/routing/README.md)
  ...
  * [URL Routing](the-basics/routing/url-routing/README.md)
    * [Routing By Convention](the-basics/routing/url-routing/adding-routes.md)
    * [Pattern Placeholders](the-basics/routing/url-routing/pattern-placeholders.md)
    * [Event Routing](the-basics/routing/url-routing/event-routing.md)
    * [RESTful Action Routing](the-basics/routing/url-routing/restful-action-routing.md)
    * [Adding variables per route](the-basics/routing/url-routing/adding-variables-per-route.md)
