...
* Create one test bundle class for each event handler you would like to test or base it off your BDD requirements
* Bundle class inherits from `coldbox.system.testing.BaseTestCase`
* The bundle class can have some annotations that tell the testing framework to what ColdBox application to connect to and test
