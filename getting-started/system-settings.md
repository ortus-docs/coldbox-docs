...
If you need to access these configuration values in other classes, consider adding the values to your [ColdBox settings](configuration-directives/coldbox.md#settings) and injecting the values into your other classes [via dependency injection.](../getting-started/configuration/using-settings.md)
