...
| `COLDBOX_CONFIG_FILE`   | `config/ColdBox.cfc` | The absolute or relative path to the configuration class file to load. This bypasses the conventions and uses the configuration file of your choice.                                                                                                                                                                                            |
