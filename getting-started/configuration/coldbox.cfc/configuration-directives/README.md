...
| --------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [async](coldbox.md#async-server-sent-events-settings) | struct | An optional structure used to configure the async package, such as the global scheduler's executor thread count                                                                                                                          |
| [cachebox](cachebox.md)                       | struct | An optional structure used to configure CacheBox. If not setup the framework will use its default configuration found in `/coldbox/system/web/config/CacheBox.bx` (or `.cfc` for CFML)                                                                       |
...
| [sse](coldbox.md#async-server-sent-events-settings) | struct | An optional structure used to configure default [Server-Sent Events](../../../../the-basics/event-handlers/server-sent-events.md) behavior. **BoxLang only.**                                                                              |
